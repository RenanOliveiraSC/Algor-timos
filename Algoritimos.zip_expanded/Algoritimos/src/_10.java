...
public class _10 {
	...
	public static void main(String[] args) {
		...
		// Nesse caso o array não precisa ter o tamanho de 100, já que a pessoa
		// se
		// perder for = 5 ele perde e
		// se vencer = 5, ele ganha, pode ser 10 para melhorar a performace do
		// for criado abaixo, nesse caso vamos deixar com tamanho 20 no caso da
		// pessoa
